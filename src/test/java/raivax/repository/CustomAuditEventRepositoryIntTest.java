package raivax.repository;

import raivax.RaivaxApp;
import raivax.config.Constants;
import raivax.config.audit.AuditEventConverter;
import raivax.domain.PersistentAuditEvent;
...
import static raivax.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
